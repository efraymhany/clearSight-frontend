...
//           <div className="absolute top-full left-0 hidden group-hover:block bg-white dark:bg-gray-800 shadow-lg rounded-lg z-20 w-56">
//             <ul className="flex flex-col text-gray-800 dark:text-gray-200">
//               <NavLink to="/diabeticRetinopathy" onClick={() => scrollTo(0, 0)} className="px-4 py-2 hover:bg-primary/10 hover:text-primary transition">
//                 👁️ Diabetic Retinopathy
//               </NavLink>
//               <NavLink to="/cataract" onClick={() => scrollTo(0, 0)} className="px-4 py-2 hover:bg-primary/10 hover:text-primary transition">
//                 🌫️ Cataract
//               </NavLink>
//               <NavLink to="/glaucomaPage" onClick={() => scrollTo(0, 0)} className="px-4 py-2 hover:bg-primary/10 hover:text-primary transition">
//                 🧿 Glaucoma
//               </NavLink>
//             </ul>
//           </div>
...
//           <div className="absolute top-full left-0 hidden group-hover:block bg-white dark:bg-gray-800 shadow-lg rounded-lg z-20 w-56">
//             <ul className="flex flex-col text-gray-800 dark:text-gray-200">
//               <NavLink to="/about" onClick={() => scrollTo(0, 0)} className="px-4 py-2 hover:bg-primary/10 hover:text-primary transition">
//                 ℹ️ About
//               </NavLink>
//               <NavLink to="/adminLogin" onClick={() => scrollTo(0, 0)} className="px-4 py-2 hover:bg-primary/10 hover:text-primary transition">
//                 🔐 Admin Panel
//               </NavLink>
//             </ul>
//           </div>
...
//             <img
//               className="w-8 h-8 rounded-full object-cover"
//               src={userData?.profilePic || assets.avatar}
//               alt="Profile"
//             />
//             <img className="w-5" src={assets.dropdown_icon} alt="Menu" />
//             <div className="absolute top-0 right-0 pt-14 z-20 hidden group-hover:block">
...
//                 {role === "Doctor" ? (
//                   <>
//                     <p onClick={() => navigate("/doctorProfile")} className="px-4 py-2 hover:bg-primary/10 hover:text-primary transition">
//                       🙋‍♂️ My Profile
//                     </p>
//                     <p onClick={() => navigate("/docPatientHistory")} className="px-4 py-2 hover:bg-primary/10 hover:text-primary transition">
//                       📝 History
//                     </p>
//                   </>
//                 ) : (
//                   <>
//                     <p onClick={() => navigate("/patientProfile")} className="px-4 py-2 hover:bg-primary/10 hover:text-primary transition">
//                       🙋 My Profile
//                     </p>
//                     <p onClick={() => navigate("/patientHistory")} className="px-4 py-2 hover:bg-primary/10 hover:text-primary transition">
//                       📜 History
//                     </p>
//                   </>
//                 )}
//                 <p onClick={logout} className="cursor-pointer text-red-500 mt-2">
//                   🚪 Logout
//                 </p>
//               </div>
//             </div>
...
//           </div>
//         ) : (
//           <button onClick={() => navigate("/login")} className="bg-primary text-white px-6 py-2 rounded-full hidden md:block">
//             🔑 Create Account
//           </button>
//         )}
...
//           <ul className="flex flex-col gap-4 mt-8 text-lg font-medium">
//             {navLinks.map((link, i) => (
//               <NavLink key={i} to={link.to} onClick={() => setShowMenu(false)} className="text-gray-800 dark:text-gray-200 hover:text-primary">
//                 {link.label}
//               </NavLink>
//             ))}
...
//               {showDiseasesDropdown && (
//                 <div className="flex flex-col gap-1 pl-4">
//                   <NavLink to="/diabeticRetinopathy" onClick={() => setShowMenu(false)} className="px-4 py-2 hover:bg-primary/10 hover:text-primary transition">
//                     👁️ Diabetic Retinopathy
//                   </NavLink>
//                   <NavLink to="/cataract" onClick={() => setShowMenu(false)} className="px-4 py-2 hover:bg-primary/10 hover:text-primary transition">
//                     🌫️ Cataract
//                   </NavLink>
//                   <NavLink to="/glaucomaPage" onClick={() => setShowMenu(false)} className="px-4 py-2 hover:bg-primary/10 hover:text-primary transition">
//                     🧿 Glaucoma
//                   </NavLink>
//                 </div>
//               )}
...
//               {showPagesDropdown && (
//                 <div className="flex flex-col gap-1 pl-4">
//                   <NavLink to="/about" onClick={() => setShowMenu(false)} className="px-4 py-2 hover:bg-primary/10 hover:text-primary transition">
//                     ℹ️ About
//                   </NavLink>
//                   <NavLink to="/adminLogin" onClick={() => setShowMenu(false)} className="px-4 py-2 hover:bg-primary/10 hover:text-primary transition">
//                     🔐 Admin Panel
//                   </NavLink>
//                 </div>
//               )}
...
//                 {role === "Doctor" ? (
//                   <>
//                     <NavLink to="/doctorProfile" onClick={() => setShowMenu(false)}>
//                       🙋‍♂️ My Profile
//                     </NavLink>
//                     <NavLink to="/docPatientHistory" onClick={() => setShowMenu(false)}>
//                       📝 History
//                     </NavLink>
//                   </>
//                 ) : (
//                   <>
//                     <NavLink to="/patientProfile" onClick={() => setShowMenu(false)}>
//                       🙋 My Profile
//                     </NavLink>
//                     <NavLink to="/patientHistory" onClick={() => setShowMenu(false)}>
//                       📜 History
//                     </NavLink>
//                   </>
//                 )}
//                 <p onClick={() => { logout(); setShowMenu(false); }} className="text-red-500 cursor-pointer">
//                   🚪 Logout
//                 </p>
//               </>
//             )}
//             {!token && (
//               <NavLink to="/login" onClick={() => setShowMenu(false)} className="hover:text-primary">
//                 🔑 Login / Signup
//               </NavLink>
//             )}
//           </ul>
